"""Prediction script for the Autoformer wrapper.

Outputs zero predictions for all items.  Replace with real model
inference logic when integrating the official Autoformer.
"""
...
def main() -> None:
    ...
    project_root = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "..", ".."))
    ckpt_dir = os.path.join(project_root, "checkpoint", "autoformer")
    ...
    out_path = os.path.join(results_dir, "autoformer_submission.csv")
