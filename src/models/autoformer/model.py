"""Autoformer model wrapper placeholder.

This placeholder returns a simple linear forecasting model.  Replace
``ForecastModel`` with the actual Autoformer network as needed.
"""
